...
public class ProcessRetrieveRequest {
	 ...
	 * @param request
	 */
	public static ProcessRetrieveResponse checkRequestParameter(
	 ...
	 * If the parameter is not set we use the default value If the parameter is
	 * not set correctly (no integer or bigger than the maximum allowed Integer
	 * or negative) we use the default value
	 * 
	 * @param request
	 * @param response
	 */
	private static Integer checkNumItems(HttpServletRequest request,
			ProcessRetrieveResponse response) {
	 ...
	 * @param response
	 */
	private static String checkTerm(HttpServletRequest request,
			ProcessRetrieveResponse response) {
